...
The website presents the history of the Juventus football team, and its best players.Users will be able to find interesting content in an easy and simple way.
This project is for educational/training purposes and can not be used as a template for a business use.The Main aim is to build responsive websites with HTML and CSS only and little JavaScript. I used flex box & CSS grid to keep the website responsive.Logo and all branding information belong to Juventus Club S.p.a.
...
The main reason to create this website is to keep all information about Juventus team history, players and news in the same place. For all fans of Juventus team and football itself.

## User goals

### New user goals:

- Users are able to find information about the team and players.- Users can easily fill in forms for all updates, news and add-ons.

### Returning user goals:

- Users can learn more about the team.

### As a business owner:

- I need to make sure that my current and new customers will find a professional help with needs of information.- I would like to build and maintain relationships with potential and current customers.

### As a new customer:

- I wish to find information about players and team.- I want to join a fan club to receive all deals and events directly connected with the Juventus team.

### As a returning customer:

- All updates, news and information about team/players/events.

## Structure of the website

The website is designed to be easy and user-friendly on all types of devices. On a desktop, tablet or mobile device there should be no difference for a user to have a fantastic experience. All parts are designed to achieve maximum user satisfaction. Users will get some interaction from the interface as links, buttons and inputs will have a hover effect.
...
The website is made on 3 pages. Three are accessible from a navigation menu which always indicates which is currently on by underline.
...
- Each site has a Contact us on the bottom. Customers can find an address, phone number and email.
...
- As a script to give functionality for the burger menu.
...
I tested on hardware devices such as: 14' screen HP laptop, 17' screen Asus laptop, 27' hp monitor, Samsung s20fe, Samsung s7 edge and Samsung Note 10.
...
The project was deployed on GitHub Pages. I used VS Code as a development environment where I commit all changes to the git version control system.I used the push command in VS Code to save changes into GitHub.
To deploy a project I had to:

- Log in to GitHub and click on repository to deploy ([MP1](https://github.com/NewViewNewBeginning/project-01-CI))- select `Settings` and find GitHub Pages section at the very bottom of the page- from source select `none` and then `Milestone-Projects` branch.- click `save` and page was deployed after auto-refresh.  > Your site is published at https://newviewnewbeginning.github.io/project-01-CI/
  To run locally:
- Log in to GitHub and click on the repository to download ([MP1](https://github.com/NewViewNewBeginning/project-01-CI))- select `Code` and click Download the ZIP file.- after download you can extract the file and use it in your local environment
  Alternatively you can [Clone](https://docs.github.com/en/free-pro-team@latest/github/creating-cloning-and-archiving-repositories/cloning-a-repository)or [Fork](https://docs.github.com/en/free-pro-team@latest/github/getting-started-with-github/fork-a-repo)this repository ([MP1](https://github.com/NewViewNewBeginning/project-01-CI)) into your github account.
  [Back to Table of contents](#table-of-contents)
...
- History text on main page [History page text copied](https://en.wikipedia.org/wiki/List_of_Juventus_F.C._records_and_statistics)
